    ...
    benefits: [
      {
        title: '角色商品化！！',
        body: [
          '入选“OMAKE 奖”的作品，将获得扭蛋商品化的权利！所有投稿作品都会进入评选范围，每位参赛者都有挑战机会。',
          '※ 由“斎藤企画”提供。',
      ...
      },
      {
        ...
        body: [],
        items: ['个人部门（2D、3D、AI）各部门 1 名：JPY 100,000', '企业角色部门 1 名：JPY 300,000'],
      },
      {
    ...
    benefits: [
      {
        title: 'キャラクターを商品化！！',
        body: [
          '「OMAKE賞」に選ばれた場合、カプセルトイ商品化の権利が得られます！すべての作品が選考対象なので、全員に挑戦のチャンスがあります。',
          '※「斎藤企画」提供。',
    ...
    benefits: [
      {
        ...
        body: [
          'Works selected for the OMAKE Award receive the right to be developed into capsule toy merchandise. Every submission is eligible, so every participant has a chance.',
      ...
      {
        title: 'Top creators in each category receive cash prizes!',
        body: [],
        items: [
